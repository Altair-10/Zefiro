    ...
    return (
      ...
      >
        <div className="relative max-w-[900px] gap-2 grid grid-cols-12 grid-rows-2 overflow-hidden row-[6/29] col-[10/42]">
          ...
          <Card
            isFooterBlurred
            className="w-full h-[300px] col-span-12 sm:col-span-5 group overflow-hidden relative transition-all duration-300 hover:shadow-2xl hover:scale-105"
          >
            <CardHeader className="absolute z-10 top-1 flex-col items-start">
          ...
          <Card
            isFooterBlurred
            className="w-full h-[300px] col-span-12 sm:col-span-7 group overflow-hidden relative transition-all duration-300 hover:shadow-2xl hover:scale-105"
          >
            <CardHeader className="absolute z-10 top-1 flex-col items-start">
              <p className="text-tiny text-white/60 uppercase font-bold">
                Your day your way
