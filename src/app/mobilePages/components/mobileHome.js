...
export default function MobileHome(){
    return(
      <div className="md:hidden flex justify-center items-center w-full mt-[15vw]">
        ...
        ">
          <div className="row-[3/5] col-[1/32] bg-blue-medium md:hidden">
            <ShapesDisplayer 
              numShapes={1} 
          ...
          <div className="row-[20/22] col-[1/31] bg-blue-dark md:hidden">
            <ShapesDisplayer 
              numShapes={4} 
          ...
          <div className="row-[7] col-[1] md:hidden">
            <h1 className="w-[76vw] text-[10vw] font-serif text-blue-dark">
              take IT for future
            </h1>
          </div>
          <div className="row-[13/16] col-[7/25] bg-orange rounded-3xl">
