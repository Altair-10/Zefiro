...
return (
    <div className="flex justify-center w-full ">
        ...
        ">
            <div className="row-[1/19] col-[1/30] md:row-[5/21] md:col-[4/20] ">
                <div className="relative flex flex-col justify-center items-center  h-full bg-orange rounded-3xl">
                    ...
                    />
                    <p className="text-[3vw] md:text-[1.5vw] px-[2vw] font-bold text-center pt-[4vw] md:pt-[2vw] text-blue-dark">
            ...
            <div className=" row-[22/33] col-[1/30] md:row-[4/12] md:col-[26/44] ">
                <div className=" flex flex-col justify-center h-full font-bold shadow-xl bg-blue-medium rounded-3xl">
                    <p className="text-[2.5vw] md:text-[1vw] px-[2vw] text-center text-brown-light">
                    ...
                    Per questo offriamo e invitiamo ad usufruire dei nostri servizi.
                    </p>
                </div>
            </div>
            ...
            <div className="row-[35/45] col-[1/30]  md:row-[14/21] md:col-[26/44] ">
                <div className=" flex flex-col justify-center h-full font-bold shadow-xl bg-blue-medium rounded-3xl">
                    <p className="text-[2.5vw] md:text-[1vw] px-[4vw] text-center text-brown-light">
                    AltAir nasce a febbraio 2025 dalla collaborazione di 4 amici 
                    che dopo aver condiviso 2 anni di studio 
                    hanno deciso di mettersi in gioco, 
                    mettendo a disposizione competenze, 
                    serietà lavorativa ed affidabilità.
                    </p>
                </div>
            </div>
            <div className="row-[33/36] col-[3/10] md:row-[13/16] md:col-[25/32]  ">
                <div className=" flex flex-col justify-center h-full font-bold shadow-xl bg-brown-light rounded-2xl">
