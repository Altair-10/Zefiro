...
function PlanCard({ cardTitle, cardCTA, items }) {
  return (
    <>
      <div className="row-[230] col-[1/32] md:row-[39] md:col-[1/49] flex justify-center items-center ">
        <h2 className="text-black text-[8vw] text-center font-semibold md:text-[5vw]">
