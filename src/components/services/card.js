...
const Card = ({ image, CardTitle, CardDescription, btnHref, animationDirection }) => {
  ...
  return (
    <div ref={cardRef} style={animationStyle} className="w-full h-full min-h-0 flex flex-col md:flex-row bg-slate-500 rounded-xl overflow-hidden">
      {/* Blocco immagine */}
      ...
      <div className="flex flex-col justify-around items-center text-center w-full h-1/2 md:w-1/2 md:h-full p-4">
        <h3 className="text-[7vw] md:text-[2vw] font-semibold text-dark dark:text-white whitespace-nowrap">
          {CardTitle}
        </h3>
